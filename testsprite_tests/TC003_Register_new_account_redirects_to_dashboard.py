...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to http://localhost:3000/register to reach the registration page (per the provided step instruction).
        await page.goto("http://localhost:3000/register", wait_until="commit", timeout=10000)
        
        # -> Fill the 'Nama' field with a display name (immediate action).
        ...
        # -> Click the 'Daftar' submit button to submit the registration form and wait for the app to redirect to the dashboard.
        frame = context.pages[-1]
        # Click element
